    ...
    <body>
        <div class="mainPage">
            ...
            <div class="navbar" id="navi"> <!-- Barre qui reste collée en haut de l'écran-->
                ...
                <a href="shopAdmin.php" class="active">Boutique</a>
            ...
            <div class="product-container">
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <div class="case">
                        ...
                        <button onclick="window.location.href='https://sparacing.com/90495-location-equipements';">Ajouter au Panier</button>
                    </div>
                    <?php
                }
                $conn->close();
            ...
            <!-- comment <div id="addProductPopup" class="popup">
